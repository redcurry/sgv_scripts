...
plot(0, 0, type = 'n', las = 1,
  xlim = c(0, 1),
  ylim = c(0, 1),
  xlab = 'Frequency of allele when it became beneficial',
  ylab = 'Cumulative frequency of occurrence')
...
legend('bottomright',
  legend = c('Populations started with SGV', 'Populations started without SGV'),
...
# Plot individual replicate cumul frequencies
#for(rep in seq(20))
#{
#  lines(break_steps + step_size, normal_sgv_cumul[normal_sgv_cumul$Replicate == rep,]$Frequency, lty = 'solid', col = 'gray')
#  lines(break_steps + step_size, no_sgv_cumul[no_sgv_cumul$Replicate == rep,]$Frequency, lty = 'dashed', col = 'gray')
#}
